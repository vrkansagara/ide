#!/usr/bin/env bash
# ==============================================================================
# args.sh — Example: argument parsing with getopts
# ==============================================================================
...
usage() {
    cat <<EOF
Usage: ${PROGNAME} [OPTIONS] [-a ARG] [-p POUT]

  Example script demonstrating getopts argument parsing.

Options:
  -a ARG        Set argument a
  -p POUT       Set argument p
