#!/usr/bin/env bash
# ==============================================================================
# yum-launch-instance.sh — Bootstrap a RHEL/Amazon Linux EC2 instance with nginx
# ==============================================================================
...
Usage: ${PROGNAME} [OPTIONS]
  ...
  Bootstrap a RHEL/Amazon Linux AWS EC2 instance: install nginx via yum,
  fetch the instance Availability Zone via IMDSv2, and write an info page.
...
EOF
    ...
    info "instance created on ${CURRENT_DATE}" | _run tee /usr/share/nginx/html/index.html

    ok "yum-launch-instance.sh ..... [DONE]"
}
