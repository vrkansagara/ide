" ==============================================================================
" File        : 001-nerdtree.vim
" Maintainer  : Vallabhdas Kansagara <vrkansagara@gmail.com> — @vrkansagara
" Version     : 2.0.0
" Description : NERDTree file explorer configuration and key bindings
" ==============================================================================

if exists('g:loaded_nerdtree_config')
    finish
endif
let g:loaded_nerdtree_config = v:true
...
augroup nerdtree_config
    ...
    " NOTE: The "bring NERDTree back" BufEnter autocmd is intentionally removed.
    " It caused odd cursor jumps and buffer-swapping when switching between files.

    " Start NERDTree when Vim opens with no file arguments.
    autocmd StdinReadPre * let s:std_in=1
    autocmd VimEnter * if argc() == 0 && !exists('s:std_in') | NERDTree | wincmd p | endif

    " Start NERDTree when Vim opens a directory — open it once, then move focus to editor.
    autocmd VimEnter * if argc() == 1 && isdirectory(argv()[0]) && !exists('s:std_in')
        \ | execute 'NERDTree' argv()[0] | execute 'cd' argv()[0] | wincmd p | enew | endif

    " Apply NERDTree-specific key options when its buffer becomes active.
...
" current directory
function! NERDTreeToggleInCurDir() abort
...
function! NERDTreeMyOpenFile(node) abort
...
function! RefreshF5nerdtree() abort
